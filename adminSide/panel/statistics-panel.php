...
<style>
    ...
    #paymentMethodChart, #paymentMethodDonutChart { width: 100% !important; max-width: 100%; height: 500px; }
    @media (max-width: 767.98px) {
        .wrapper{ padding-left: 16px; padding-right: 16px; }
        .container-fluid{ padding-left: 0; padding-right: 0; }
        .col-md-10{ margin-left: 0 !important; }
        #paymentMethodChart, #paymentMethodDonutChart { height: 320px !important; }
    }
</style>
