...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uniqueString == "9999912345") {
        ...
        header("Location: ../stockCrud/deleteStock.php?id=" . $itemID);
        exit();
    } else {
    ...
    <div class="login-container">
        <div class="login_wrapper">
            <div class="wrapper">
                ...
                <h5>Admin Credentials needed to Delete Stock Item</h5>
                <form action="" method="post">
                    ...
                    <button class="btn btn-light" type="submit" name="submit" value="submit">Delete Stock Item</button>
