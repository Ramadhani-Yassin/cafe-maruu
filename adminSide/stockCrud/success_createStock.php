...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $expensePerUnit = $_POST["expensePerUnit"] ?? 0.00;
    $conn = $link;
    ...
    if ($check_result->num_rows > 0) {
        ...
        $insert_query = "INSERT INTO stock (ItemName, BaseUnitQuantity, ConversionRatio, PricePerBaseUnit, PricePerSubUnit, expense_per_unit) 
                        VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($insert_query);

        // Bind the parameters
        $stmt->bind_param("siiddd", $itemName, $baseUnitQuantity, $conversionRatio, $pricePerBaseUnit, $pricePerSubUnit, $expensePerUnit);
